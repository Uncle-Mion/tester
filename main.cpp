...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "rareshares-seeder\n"
...
static const string mainnet_seeds[] = {"seed.rareshares.tk", ""};
static const string testnet_seeds[] = {"seed.rareshares.tk", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("45.77.7.15", 9666), true);
  }
  do {
